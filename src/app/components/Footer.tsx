      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <h3 className="text-xl">Kigali Harvest School</h3>
            </div>
            <p className="text-blue-200">Quality education rooted in Christian values</p>
          </div>
          ...
          <div>
            <h4 className="text-lg mb-4">Programs</h4>
            <ul className="space-y-2">
              <li className="text-blue-200">Nursery School (Ages 2-5)</li>
              <li className="text-blue-200">Primary School (Grades 1-6)</li>
              <li className="text-blue-200">Club Activities</li>
              <li className="text-blue-200">Christian Education</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a
                href="https://instagram.com/kigaliharvestschool"
                target="_blank"
        ...
        <div className="border-t border-blue-700 pt-8 text-center">
          <p className="text-blue-200">
            &copy; 2026 Kigali Harvest School - A Ministry of Restoration Church. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
